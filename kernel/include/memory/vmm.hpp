...
namespace vmm {
    uintptr_t find_free_addr(uint64_t cr3, size_t length);
    ...
    void track(uint64_t cr3, uintptr_t base, size_t length, size_t flags);
    void vmm_free(uint64_t cr3, void* ptr);
}
